!define APPNAME "jdAppStreamEdit"
!define APPBIN "$INSTDIR\${APPNAME}.exe"
!define EXTERNALBIN "$INSTDIR\ExternalReleasesEditor.exe"
...
!define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\JakobDev\${APPNAME}"
...
Section
    ...
    !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
      ...
      CreateShortcut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "${APPBIN}"
      CreateShortcut "$SMPROGRAMS\$StartMenuFolder\jdAppStreamEdit External Releases Editor.lnk" "${EXTERNALBIN}"
      CreateShortcut "$SMPROGRAMS\$StartMenuFolder\Uninstall jdAppStreamEdit.lnk" "$INSTDIR\Uninstall.exe"
    !insertmacro MUI_STARTMENU_WRITE_END

    ; Add file handler
    WriteRegStr SHCTX "Software\Classes\jdAppStreamEdit.AppStream\shell\open" "FriendlyAppName" "jdAppStreamEdit"
    WriteRegStr SHCTX "Software\Classes\jdAppStreamEdit.AppStream\shell\open\command" "" "$\"${APPBIN}$\" $\"%1$\""

    WriteRegStr SHCTX "Software\Classes\jdAppStreamEdit.ExternalReleases\shell\open" "FriendlyAppName" "jdAppStreamEdit External Releases Editor"
    WriteRegStr SHCTX "Software\Classes\jdAppStreamEdit.ExternalReleases\shell\open\command" "" "$\"${EXTERNALBIN}$\" $\"%1$\""

    WriteRegStr SHCTX "Software\Classes\.xml\OpenWithProgids" "jdAppStreamEdit.AppStream" ""
    WriteRegStr SHCTX "Software\Classes\.xml\OpenWithProgids" "jdAppStreamEdit.ExternalReleases" ""
...
Section "Uninstall"
    ...
    DeleteRegKey SHCTX "Software\Classes\jdAppStreamEdit.AppStream"
    DeleteRegKey SHCTX "Software\Classes\jdAppStreamEdit.ExternalReleases"
    DeleteRegValue SHCTX "Software\Classes\.xml\OpenWithProgids" "jdAppStreamEdit.AppStream"
    DeleteRegValue SHCTX "Software\Classes\.xml\OpenWithProgids" "jdAppStreamEdit.ExternalReleases"
