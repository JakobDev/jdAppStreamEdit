...
def main() -> None:
    ...
    component.load_file(root_dir / "deploy" / "page.codeberg.JakobDev.jdAppStreamEdit.metainfo.xml")
    ...
    if args.stdout:
        ...
        with open(root_dir / "jdAppStreamEdit" / "data" / "changelog.html", "w", encoding="utf-8", newline="\n") as f:
            f.write(html_text)
